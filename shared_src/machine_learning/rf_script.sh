#!/bin/bash
echo "data/LC_dewet_prune2_w0.png" | python gridsearch_randomforest.py -k 10 -n 50 -P --seed 1 -D 2 "data/features_dewetting_woclass0,1.csv"  1> data/pruning2_dewetting_w0.txt
echo "data/LC_dewet_prune3_w0.png" | python gridsearch_randomforest.py -k 10 -n 50 -P --seed 1 -D 3 "data/features_dewetting_woclass0,1.csv"  1> data/pruning3_dewetting_w0.txt
echo "data/LC_dewet_prune4_w0.png" | python gridsearch_randomforest.py -k 10 -n 50 -P --seed 1 -D 4 "data/features_dewetting_woclass0,1.csv"  1> data/pruning4_dewetting_w0.txt
echo "data/LC_dewet_prune5_w0.png" | python gridsearch_randomforest.py -k 10 -n 50 -P --seed 1 -D 5 "data/features_dewetting_woclass0,1.csv"  1> data/pruning5_dewetting_w0.txt
echo "data/LC_dewet_prune6_w0.png" | python gridsearch_randomforest.py -k 10 -n 50 -P --seed 1 -D 6 "data/features_dewetting_woclass0,1.csv"  1> data/pruning6_dewetting_w0.txt
echo "data/LC_dewet_prune7_w0.png" | python gridsearch_randomforest.py -k 10 -n 50 -P --seed 1 -D 7 "data/features_dewetting_woclass0,1.csv"  1> data/pruning7_dewetting_w0.txt
echo "data/LC_dewet_prune8_w0.png" | python gridsearch_randomforest.py -k 10 -n 50 -P --seed 1 -D 8 "data/features_dewetting_woclass0,1.csv"  1> data/pruning8_dewetting_w0.txt
